...
def main():
    ...
    parser.add_argument("--n_trials", default=16, type=int)
    ...
    search_space = {
    'custom_layer_init': [0.5,1],
    'custom_lr_schedule': ["No","Transformer"],
    'layer_type' : [3,6],
    'loss_function': ["element_wise_huber_loss"], #"element_wise_squared_loss"
