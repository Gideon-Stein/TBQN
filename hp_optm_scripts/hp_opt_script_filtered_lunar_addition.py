...
class objective(object):
    ...
    def __call__(self, trial):
	    ...
	    layer_type = trial.suggest_categorical('layer_type', [1,3,6]) # [1,2,3,5,6,7]		
...
def main():
    ...
    'layer_type' : [3],
    'loss_function': ["element_wise_squared_loss","element_wise_huber_loss"], #"element_wise_squared_loss"
