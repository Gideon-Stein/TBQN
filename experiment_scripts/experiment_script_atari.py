...
def main():
    ...
    ##Training parameters
    parser.add_argument('--num_iterations', type=int, default=500000,help="steps in the env")
    ...
    parser.add_argument("--encoder_type", default=5, type=int,help="Which Type of encoder is used for the model")
